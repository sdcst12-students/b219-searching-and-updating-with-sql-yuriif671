...
def editCustomer():
    ...
    if customer:
        ...
        while True:
            print("\nChoose:")
            print("A: change first name  B: change last name  C: change phone number")
            print("D: change email        E: change address     F: change city")
            print("G: change postal code  I: finish update")
